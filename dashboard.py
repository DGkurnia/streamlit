...
aotizdf = pd.read_csv('D:\knowledge\assignment\dicode-python\submisi\dashboard\aqinsc\aotizhongxin-c.csv')
changdf = pd.read_csv('D:\knowledge\assignment\dicode-python\submisi\dashboard\aqinsc\changping-c.csv')
dingdf = pd.read_csv('D:\knowledge\assignment\dicode-python\submisi\dashboard\aqinsc\dingling-c.csv')
dongdf = pd.read_csv('D:\knowledge\assignment\dicode-python\submisi\dashboard\aqinsc\dongsi-c.csv')
guadf = pd.read_csv('D:\knowledge\assignment\dicode-python\submisi\dashboard\aqinsc\guanyuan-c.csv')
gucdf = pd.read_csv('D:\knowledge\assignment\dicode-python\submisi\dashboard\aqinsc\gucheng-c.csv')
huadf = pd.read_csv('D:\knowledge\assignment\dicode-python\submisi\dashboard\aqinsc\huairo-c.csv')
nonzhadf = pd.read_csv('D:\knowledge\assignment\dicode-python\submisi\dashboard\aqinsc\nonzhanguan-c.csv')
shundf = pd.read_csv('D:\knowledge\assignment\dicode-python\submisi\dashboard\aqinsc\shunyi-c.csv')
tiadf =  pd.read_csv('D:\knowledge\assignment\dicode-python\submisi\dashboard\aqinsc\tiantan-c.csv')
waldf = pd.read_csv('D:\knowledge\assignment\dicode-python\submisi\dashboard\aqinsc\wanliu-c.csv')
waxdf = pd.read_csv('D:\knowledge\assignment\dicode-python\submisi\dashboard\aqinsc\wanshouxigong-c.csv')
